<template>
    <section class="hero-section">
      ...
      <div class="content-wrapper">
        ...
        <p class="description">I'm a Full-Stack Developer dedicated to crafting seamless and efficient web applications.</p>
          ...
          <div class="tech-icons">
            <div class="tech-icon">
              <svg class="nuxt-icon" viewBox="0 0 124 124" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M55.7498 27.1551C52.5277 21.615 44.4723 21.615 41.2502 27.1551L6.13404 87.5347C2.91195 93.0748 6.93963 100 13.3838 100H83.6162C90.0604 100 94.0881 93.0748 90.866 87.5347L55.7498 27.1551Z" fill="#00DC82"/>
              </svg>
            </div>
            <div class="tech-icon">
